...
| Fail CI if graph-link footers go stale (`tools/gen_graph_links.py --check`) | Re-run the generator after adding/removing references |
...
## Vault graph
[[AGENTS|AGENTS]] · [[_review/2026-07-03-full-vault-audit|2026-07-03-full-vault-audit]] · [[_review/Change Request Template|Change Request Template]] · [[_review/Governance|Governance]] · [[_review/Team Sharing Setup|Team Sharing Setup]] · [[design-brain/defaults|defaults]] · [[discovery/README|discovery README]] · [[discovery/_TEMPLATE|discovery _TEMPLATE]]
<!-- graph-links:end -->
