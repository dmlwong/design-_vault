...
- ❌ Importing a third-party icon library (`lucide-react`, `react-icons`, FontAwesome React, etc.). Orbit uses the `FaIcon` primitive only — anything else is a defect and isn't even installed.
