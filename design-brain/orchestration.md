...
- **Lessons-inbox triage (manual, needs judgment):** run the `vault-librarian` agent in
  ...
  older than two weeks is itself a health smell.
...
## Vault graph
[[AGENTS|AGENTS]] · [[_review/2026-07-17-orchestration-and-optimisation-proposal|2026-07-17-orchestration-and-optimisation-proposal]] · [[design-brain/brief-contract|brief-contract]] · [[design-brain/lessons/INBOX|lessons INBOX]] · [[design-brain/lovable/knowledge-base|knowledge-base]] · [[design-brain/storybook|storybook]]
<!-- graph-links:end -->
