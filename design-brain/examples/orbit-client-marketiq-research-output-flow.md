...
## Vault graph
[[design-brain/examples/orbit-client-marketiq-guided-workflow|orbit-client-marketiq-guided-workflow]] · [[design-brain/examples/orbit-client-marketiq-research-output-next-actions|orbit-client-marketiq-research-output-next-actions]] · [[design-brain/interaction-defaults|interaction-defaults]] · [[design-brain/patterns/config-wizard|config-wizard]] · [[design-brain/patterns/guided-conversational-workflow|guided-conversational-workflow]] · [[design-brain/patterns/review-and-approve-workflow|review-and-approve-workflow]] · [[design-brain/patterns/tool-hub|tool-hub]]
<!-- graph-links:end -->
