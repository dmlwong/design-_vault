...
## Known Limits
- `Table` has no Storybook stories yet, so its variants and states are read from source
  alone. Storybook is wired up — see `design-brain/storybook.md`.
...
## Vault graph
[[_benchmarks/results/2026-06-14-clauseiq-results-table|2026-06-14-clauseiq-results-table]] · [[_benchmarks/results/2026-06-15-golden-visual-reference|2026-06-15-golden-visual-reference]] · [[design-brain/storybook|storybook]]
<!-- graph-links:end -->
