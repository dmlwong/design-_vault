...
- `Input` and `Dropdown` have no Storybook stories yet, so their variants and states are
  read from source alone. Storybook is wired up — see `design-brain/storybook.md`.
...
## Vault graph
[[_benchmarks/results/2026-06-15-golden-visual-reference|2026-06-15-golden-visual-reference]] · [[_benchmarks/results/2026-06-15-procurement-settings-form|2026-06-15-procurement-settings-form]] · [[design-brain/storybook|storybook]]
<!-- graph-links:end -->
