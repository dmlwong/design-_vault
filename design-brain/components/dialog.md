...
- `packages/orbit/src/feedback/Overlay.module.css`
- `packages/orbit/src/feedback/Overlay.test.tsx`
- ClauseIQ usage: `InitiativeSelectionModal` in `apps/prototypes/components/feature/clauseiq/ClauseIQPrototype.tsx`
