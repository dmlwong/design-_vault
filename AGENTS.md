...
| Writing or reading Storybook stories | `design-brain/storybook.md` (+ `design-brain/skills/write-stories/SKILL.md`) |
| Reviewing a concept brief at intake | `design-brain/brief-contract.md` (+ `design-brain/agents/brief-reviewer.md`) |
| Exploring a gated brief as a throwaway concept | `design-brain/skills/explore/SKILL.md` |
| Defining behaviour after a Ready verdict (Definition Pack) | `design-brain/skills/define/SKILL.md` (+ `discovery/definition/_TEMPLATE-scenario-matrix.md` and the golden example beside it) |
| Archiving or reading an explore prototype | `discovery/prototypes/_TEMPLATE-record.md` (records live beside it) |
...
vault-librarian triages entries into proposed edits in regular manual sessions
(`design-brain/orchestration.md`, Scheduled maintenance; the inbox must trend toward empty). Either way, the correction
...
## Vault graph
[[CLAUDE|CLAUDE]] · [[_review/Change Request Template|Change Request Template]] · [[design-brain/accessibility|accessibility]] · [[design-brain/agents/brief-reviewer|brief-reviewer]] · [[design-brain/agents/design-reviewer|design-reviewer]] · [[design-brain/anti-patterns|anti-patterns]] · [[design-brain/brief-contract|brief-contract]] · [[design-brain/components/_TEMPLATE|components _TEMPLATE]] · [[design-brain/data-viz|data-viz]] · [[design-brain/defaults|defaults]] · [[design-brain/interaction-defaults|interaction-defaults]] · [[design-brain/lessons/INBOX|lessons INBOX]] · [[design-brain/lovable/knowledge-base|knowledge-base]] · [[design-brain/motion|motion]] · [[design-brain/orchestration|orchestration]] · [[design-brain/principles|principles]] · [[design-brain/skills/define/SKILL|define SKILL]] · [[design-brain/skills/explore/SKILL|explore SKILL]] · [[design-brain/skills/extract-contract/SKILL|extract-contract SKILL]] · [[design-brain/skills/port-to-orbit/SKILL|port-to-orbit SKILL]] · [[design-brain/skills/write-stories/SKILL|write-stories SKILL]] · [[design-brain/storybook|storybook]] · [[design-brain/tokens|tokens]] · [[design-brain/ux-copy|ux-copy]] · [[discovery/definition/_TEMPLATE-scenario-matrix|_TEMPLATE-scenario-matrix]] · [[discovery/prototypes/_TEMPLATE-record|_TEMPLATE-record]]
<!-- graph-links:end -->
